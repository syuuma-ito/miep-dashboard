        ...
        <div className="relative">
            <div className="flex items-center gap-2">
                <button
                    ...
                    className={`w-12 h-12 rounded border-2 border-gray-300 flex items-center justify-center ${disabled ? "opacity-50 cursor-not-allowed" : "cursor-pointer"}`}
            ...
            {isOpen && (
                <div className="absolute top-full left-0 mt-2 bg-white border border-gray-300 rounded-lg shadow-lg p-3 z-10 min-w-[200px]">
                    ...
                    <div className="mt-3 pt-3 border-t">
                        ...
                        <input type="color" value={color} onChange={(e) => onChange(e.target.value)} className="w-full h-8 rounded border border-gray-300 cursor-pointer" />
                    </div>
                </div>
            )}
